        ...
        DB::transaction(function () use ($validated, $stock) {
            ...
            if ($newQty !== $oldQty) {
                RentalSparepartMovement::create([
                    ...
                    'actual_customer' => $allocationCustomer ?: $sourceCustomer,
                    'actual_location' => $allocationLocation ?: $sourceLocation,
                    'actual_type_unit' => $allocationTypeUnit ?: $sourceTypeUnit,
                    'actual_sn_unit' => $allocationSnUnit ?: $sourceSnUnit,
                    'pic_user_id' => $user->id,
                    'pic_name' => $user->name,
        ...
        DB::transaction(function () use ($stock, $validated) {
            ...
            if ($oldQty > 0) {
                RentalSparepartMovement::create([
                    ...
                    'actual_customer' => $stock->allocation_customer ?: $stock->source_customer,
                    'actual_location' => $stock->allocation_location ?: $stock->source_location,
                    'actual_type_unit' => $stock->allocation_type_unit ?: $stock->source_type_unit,
                    'actual_sn_unit' => $stock->allocation_sn_unit ?: $stock->source_sn_unit,
                    'pic_user_id' => $user->id,
                    'pic_name' => $user->name,
