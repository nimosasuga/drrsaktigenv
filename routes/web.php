...
use App\Http\Controllers\LicenseBulkController;
...
use App\Http\Middleware\EnsureRentalSparepartManager;
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware([CheckSuperAdmin::class])->prefix('admin')->name('admin.')->group(function () {
        ...
        Route::get('/lisensi-bulk', [LicenseBulkController::class, 'index'])->name('license-bulk.index');
        Route::get('/lisensi-bulk/users/export', [LicenseBulkController::class, 'exportUsers'])->name('license-bulk.users.export');
        Route::get('/lisensi-bulk/audit/{batch}', [LicenseBulkController::class, 'show'])->name('license-bulk.show');
        Route::get('/lisensi-bulk/audit/{batch}/export', [LicenseBulkController::class, 'export'])->name('license-bulk.export');
        Route::post('/lisensi-bulk/preview', [LicenseBulkController::class, 'preview'])->name('license-bulk.preview');
        Route::post('/lisensi-bulk/confirm', [LicenseBulkController::class, 'confirm'])->name('license-bulk.confirm');
    ...
    Route::middleware([CheckSubscription::class])->group(function () {
        ...
        Route::middleware([EnsureRentalSparepartManager::class])->group(function () {
            ...
            Route::get('/sparepart-recommendations/units', [SparepartRecommendationControlController::class, 'units'])->name('sparepart-recommendations.units');
            Route::get('/sparepart-recommendations/units/export', [SparepartRecommendationControlController::class, 'unitsExport'])->name('sparepart-recommendations.units.export');
            ...
            Route::post('/rental-spareparts/adjustments/confirm', [RentalSparepartAdjustmentImportController::class, 'confirm'])->name('rental-spareparts.adjustments.confirm');
            Route::post('/rental-spareparts/adjustments/cancel', [RentalSparepartAdjustmentImportController::class, 'cancel'])->name('rental-spareparts.adjustments.cancel');
            ...
            Route::get('/rental-spareparts/import-batches', [\App\Http\Controllers\RentalSparepartImportBatchController::class, 'index'])->name('rental-spareparts.import-batches.index');
            Route::post('/rental-spareparts/import-batches/{batch}/rollback', [\App\Http\Controllers\RentalSparepartImportBatchController::class, 'rollback'])->name('rental-spareparts.import-batches.rollback');
        ...
        Route::get('/ai-analytics', AiAnalyticsController::class)->name('ai-analytics.index');
