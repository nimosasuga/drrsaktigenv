    ...
    <form action="{{ route('penarikans.store') }}" method="POST" class="space-y-6">
        ...
        <section class="rounded-3xl border border-slate-100 bg-white p-5 shadow-sm sm:p-6">
            ...
            <div class="grid gap-5 md:grid-cols-2">
                ...
                <div class="grid grid-cols-2 gap-3"><div><label class="mb-1 block text-xs font-bold text-slate-600">IN</label><input type="time" name="in_time" class="w-full rounded-2xl border border-slate-300 px-4 py-3 text-sm"></div><div><label class="mb-1 block text-xs font-bold text-slate-600">OUT</label><input type="time" name="out_time" class="w-full rounded-2xl border border-slate-300 px-4 py-3 text-sm"></div></div>
