                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <select name="battery_type" id="battery_type" required
                                ...
                                <option value="{{ $option }}" {{ old('battery_type') === $option ? 'selected' : '' }}>
                                    {{ $option }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <select name="battery_brand" id="battery_brand" required
                                ...
                                @foreach(($batteryBrandOptions ?? ['EIKTO', 'ENEROC', 'JUNGHEINRICH', 'YUASA', 'GS', 'MIDAC']) as $option)
                                <option value="{{ $option }}" {{ old('battery_brand') === $option ? 'selected' : '' }}>
                                    {{ $option }}
                                </option>
                                @endforeach
                            </select>
