...
<body
    ...
    <aside id="sidebar"
        ...
        <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
            ...
            @php
                ...
                $canOpenAiAnalytics = $sidebarStatusUser !== 'mekanik';
            ...
            @if($canOpenAiAnalytics && \Illuminate\Support\Facades\Route::has('ai-analytics.index'))
            <a href="{{ route('ai-analytics.index') }}"
                class="group flex items-center px-3 py-2.5 text-sm font-medium rounded-xl transition-colors mt-1 {{ request()->routeIs('ai-analytics.*') ? 'bg-blue-50 text-blue-700' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900' }}">
                <svg class="w-5 h-5 mr-3 {{ request()->routeIs('ai-analytics.*') ? 'text-blue-600' : 'text-slate-400 group-hover:text-slate-600' }}"
                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M9 17v-2m3 2v-6m3 6V7m4 13H5a2 2 0 01-2-2V6a2 2 0 012-2h4l2 2h8a2 2 0 012 2v10a2 2 0 01-2 2z">
                    </path>
                </svg>
                Smart Analytics
            </a>
            ...
            <p class="px-3 text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2 mt-6">Admin Management</p>
            ...
            <a href="{{ route('admin.license-bulk.index') }}"
                class="group flex items-center px-3 py-2.5 text-sm font-medium rounded-xl text-slate-600 hover:bg-slate-50 hover:text-slate-900 transition-colors mt-1 {{ request()->routeIs('admin.license-bulk.*') ? 'bg-blue-50 text-blue-700' : '' }}">
                <svg class="w-5 h-5 mr-3 {{ request()->routeIs('admin.license-bulk.*') ? 'text-blue-600' : 'text-slate-400 group-hover:text-slate-600' }} transition-colors"
                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M9 12h6m-6 4h6M7 4h10a2 2 0 012 2v12a2 2 0 01-2 2H7a2 2 0 01-2-2V6a2 2 0 012-2zm4 0v4m2-4v4" />
                </svg>
                Bulk License
            </a>
    ...
    <div class="flex-1 flex flex-col min-w-0 bg-slate-100 p-0 lg:p-3">
        ...
        <header
            ...
            <!-- Sidebar Toggle -->
            <button type="button" id="sidebar-toggle" onclick="toggleSidebar()" aria-label="Show or hide menu"
                aria-expanded="true"
            ...
            <div x-data="{ openJobMenu: false }" class="relative flex flex-col items-center justify-center">
                ...
                <div x-show="openJobMenu" @click.away="openJobMenu = false" style="display: none;"
                    ...
                    <a href="{{ route('batteries.index') }}"
                        ...
                        <span class="text-sm font-bold text-slate-700 group-hover:text-emerald-700">Battery
                            Management</span>
                    </a>
                    ...
                    <a href="{{ route('penarikans.index') }}"
                        ...
                        <span class="text-sm font-bold text-slate-700 group-hover:text-rose-700">Unit Withdrawal</span>
                    </a>
