...
<div class="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between">
    <div>
        ...
        <p class="mt-1 text-sm text-slate-500">Ubah informasi untuk aset dengan S/N: <strong class="text-slate-700">{{
                $asset->serial_number }}</strong></p>
    </div>
                ...
                <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="text" name="unit_type" id="unit_type"
                            value="{{ old('unit_type', $asset->unit_type) }}"
                            class="mt-1 block w-full rounded-xl border border-slate-300 px-3 py-2 text-slate-900 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 sm:text-sm transition-colors">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="jenis_unit" id="jenis_unit"
                            value="{{ old('jenis_unit', $asset->jenis_unit) }}"
                            class="mt-1 block w-full rounded-xl border border-slate-300 px-3 py-2 text-slate-900 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 sm:text-sm transition-colors">
                    </div>

                    <div>
                        <label for="year" class="block text-sm font-medium text-slate-700">Tahun Pembuatan</label>
                        <input type="number" name="year" id="year" value="{{ old('year', $asset->year) }}"
                            class="mt-1 block w-full rounded-xl border border-slate-300 px-3 py-2 text-slate-900 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 sm:text-sm transition-colors">
                    </div>
                    ...
                    <div>
                        ...
                        <select name="status" id="status" required
                            ...
                            <option value="RENTAL" {{ old('status', $asset->status) == 'RENTAL' ? 'selected' : ''
                                }}>RENTAL</option>
                            <option value="BACKUP" {{ old('status', $asset->status) == 'BACKUP' ? 'selected' : ''
                                }}>BACKUP</option>
                            <option value="DITARIK" {{ old('status', $asset->status) == 'DITARIK' ? 'selected' : ''
                                }}>DITARIK</option>
                        </select>
                    </div>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="text" name="supported_by" id="supported_by"
                            value="{{ old('supported_by', $asset->supported_by) }}"
                            class="mt-1 block w-full rounded-xl border border-slate-300 px-3 py-2 text-slate-900 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 sm:text-sm transition-colors">
                    </div>
