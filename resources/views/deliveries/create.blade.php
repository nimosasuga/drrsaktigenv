    ...
    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            ...
            <h1 class="mt-1 text-2xl font-bold tracking-tight text-slate-900">
                Tambah Delivery Unit
            </h1>
            <p class="mt-1 text-sm text-slate-500">
                Input data pengiriman unit, battery, charger, trolly, kendaraan, dan status akhir unit.
            </p>
        </div>
        ...
        <div class="flex items-start gap-3">
            ...
            <div>
                ...
                <p class="mt-1 text-xs font-semibold text-blue-700">
                    PIC: {{ $user->name }} &bull; Role: {{ $statusUser }} &bull; Branch: {{ $branch }}
                </p>
            </div>
        </div>
    </div>

    <form id="form-delivery" action="{{ route('deliveries.store') }}" method="POST" class="space-y-6">
        @csrf
            ...
            <div class="grid gap-5 p-5 sm:p-6 md:grid-cols-2 lg:grid-cols-4">
                ...
                <div>
                    ...
                    <select name="partner" id="partner"
                        ...
                        <option value="{{ $partner->name }}" {{ old('partner')===$partner->name ? 'selected' : '' }}>
                            {{ $partner->name }}
                        </option>
                        @endforeach
                    </select>
                ...
                <div class="space-y-5">
                    <div>
                        ...
                        <input type="text" name="vehicle" id="vehicle" value="{{ old('vehicle') }}" required
                            placeholder="Contoh: L300 / Hilux / Service Car"
                    ...
                    <div>
                        ...
                        <input type="text" name="nopol" id="nopol" value="{{ old('nopol') }}" required
                ...
                <div class="space-y-5">
                    <div class="relative">
                        ...
                        <input type="text" name="serial_number" id="serial_number" value="{{ old('serial_number') }}"
                            required placeholder="Ketik minimal 2 karakter untuk cari asset" autocomplete="off"
                            class="uppercase-input w-full rounded-2xl border border-slate-300 bg-white px-4 py-3 text-sm text-slate-900 placeholder:text-slate-400 transition focus:border-blue-500 focus:outline-none focus:ring-4 focus:ring-blue-100">
            ...
            <div class="grid gap-6 p-5 sm:p-6 md:grid-cols-2">
                ...
                <div>
                    ...
                    <select name="status_unit" id="status_unit" required
                        class="w-full rounded-2xl border border-slate-300 bg-white px-4 py-3 text-sm text-slate-900 transition focus:border-blue-500 focus:outline-none focus:ring-4 focus:ring-blue-100">
                        <option value="RFU" {{ old('status_unit', 'RFU' )==='RFU' ? 'selected' : '' }}>
                            RFU
                        </option>
                        <option value="BREAKDOWN" {{ old('status_unit')==='BREAKDOWN' ? 'selected' : '' }}>
                            BREAKDOWN
                        </option>
                    </select>
                </div>
            ...
            <div class="grid gap-6 p-5 sm:p-6 md:grid-cols-2">
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="battery_sn" id="battery_sn" value="{{ old('battery_sn') }}"
                            class="uppercase-input w-full rounded-2xl border border-slate-300 bg-white px-4 py-3 text-sm text-slate-900 transition focus:border-blue-500 focus:outline-none focus:ring-4 focus:ring-blue-100">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="trolly" id="trolly" value="{{ old('trolly') }}"
                            class="uppercase-input w-full rounded-2xl border border-slate-300 bg-white px-4 py-3 text-sm text-slate-900 transition focus:border-blue-500 focus:outline-none focus:ring-4 focus:ring-blue-100">
                    </div>
                </div>
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="charger_sn" id="charger_sn" value="{{ old('charger_sn') }}"
                            class="uppercase-input w-full rounded-2xl border border-slate-300 bg-white px-4 py-3 text-sm text-slate-900 transition focus:border-blue-500 focus:outline-none focus:ring-4 focus:ring-blue-100">
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="note" id="note" rows="4" placeholder="Catatan tambahan delivery..."
                            class="w-full rounded-2xl border border-slate-300 bg-white px-4 py-3 text-sm text-slate-900 placeholder:text-slate-400 transition focus:border-blue-500 focus:outline-none focus:ring-4 focus:ring-blue-100">{{ old('note') }}</textarea>
                    </div>
                </div>
            </div>
        </section>
